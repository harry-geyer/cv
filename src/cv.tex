...
\begin{document}
    ...
    \begin{adjustwidth}{1 cm}{1 cm}
        \begin{it}
        \justifying
        Embedded Systems Engineer with 5+ years of experiance designing real-time firmware and scalable backend systems for industrial IoT applications.
        Proven track record in Linux kernel contributions, performance optimization and client-facing delivery.
        \end{it}
    \end{adjustwidth}
